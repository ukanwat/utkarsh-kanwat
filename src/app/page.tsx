...
const experiences: Experience[] = [
  {
    ...
    achievements: [
      "Fine-tuning Gemini models on proprietary banking documentation, achieving 18% improvement in answer relevance", 
      "Building production RAG systems with vector databases for context-aware AI responses across enterprise applications",
      "Optimizing large-scale database queries serving 1000+ daily operations, reducing response times from 3s to 1s",
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <h4 className="text-xl font-medium text-slate-900 group-hover:text-blue-600 transition-colors leading-snug">
                    <Link href="/writing/building-scalable-ai-agents">
                      Building Scalable AI Agent Orchestration Platforms
                    </Link>
                  </h4>
                  
                  <p className="text-slate-600 leading-relaxed">
                    Lessons learned from building GenBase, an open-source platform for modular AI agent orchestration with Docker and FastAPI. 
                    Explore the challenges of creating composable AI systems and architectural decisions that led to 3x faster development cycles.
                  </p>
                </div>

                <div className="flex flex-wrap gap-1.5">
                  {["AI", "Docker", "FastAPI", "Microservices"].map((tag) => (
                    <span 
                      key={tag}
                ...
                <div className="pt-2">
                  <Link 
                    href="/writing/building-scalable-ai-agents"
        ...
        <footer className="py-12 border-t border-slate-100 mt-12">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-slate-500">Currently at ANZ Banking Group</p>
            </div>
